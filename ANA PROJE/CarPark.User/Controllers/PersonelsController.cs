...
using CarPark.Business.tcDogrulama;
...
namespace CarPark.User.Controllers
{
    ...
    public class PersonelsController : Controller
    {
        ...
        {
            tcDog tcDog = new tcDog();
                    

            if (tcDog.dogrulama(personelInfo))
            {
            ...
            {
                return Json(new { message = "Tc Kimlik Numaranız doğrulanamadı!!!", success = false });
